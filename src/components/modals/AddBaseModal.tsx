        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="relative w-full max-w-5xl h-[90vh] bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-0 overflow-y-auto animate-fade-in">
                ...
                <form className="space-y-8 px-8 py-6" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                />
                                {error?.basePrice && <span className="text-red-500">{error?.basePrice}</span>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                />
                                {error?.actualPrice && <span className="text-red-500">{error?.actualPrice}</span>}
                            </div>
                        </div>
                    </div>
                    <hr className="border-gray-200 dark:border-gray-700" />
                    ...
                    {/* Size */}
                    <div>
                        <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Size</h2>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input
                                    type="number"
                                    value={size.length}
                                    onChange={e => setSize(s => ({ ...s, length: e.target.value }))}
                                    className={inputClass}
                                    placeholder="Length"
                                />
                            </div>
                    ...
                    <div>
                        ...
                        <div
                            className={`border-2 border-dashed rounded p-4 text-center cursor-pointer transition ${
                                dragActiveThumb ? "border-blue-500 bg-blue-50" : "border-gray-300 dark:border-gray-700"
                            }`}
                            onDragOver={(e) => {
                                e.preventDefault();
                        ...
                        >
                            <input id="thumbnail-input" type="file" accept="image/*" className="hidden" onChange={handleThumbnailInput} />
                    ...
                    <div>
                        ...
                        <div
                            className={`border-2 border-dashed rounded p-4 text-center cursor-pointer transition ${
                                dragActiveImages ? "border-blue-500 bg-blue-50" : "border-gray-300 dark:border-gray-700"
                            }`}
                            onDragOver={(e) => {
                                e.preventDefault();
                        ...
                        >
                            <input id="images-input" type="file" accept="image/*" multiple className="hidden" onChange={handleImagesInput} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0"
                                />
                                {error?.quantity && <span className="text-red-500">{error?.quantity}</span>}
                            </div>
                            <div>
                            ...
                            <div className="flex items-center gap-6 mt-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Switch
                                        ...
                                        onChange={(e: any) => setFormData({ ...formData, allowBackorder: e.target.checked })}
                                        size="md"
                                        color="success"
                                    />
                                </div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <Switch
                                        ...
                                        onChange={(e: any) => setFormData({ ...formData, isTrackable: e.target.checked })}
                                        size="md"
                                        color="success"
                                    />
                                </div>
